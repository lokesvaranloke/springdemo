...
@Component("employeedao")   //if specific name is not given like this then it will take class name as default with camel case employeeDAOImpl
							//this name is as same as we give in employeeapp in getbean
